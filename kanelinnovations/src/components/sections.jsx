...
const Reveal = ({ children, className = '', delay = 0, direction = 'up' }) => {
  ...
  return (
    <div
      ref={ref}
      className={`${animClass} ${visible ? 'scroll-animate' : ''} ${className}`}
...
export const Home = () => (
  <AnimatedSection
    id="home"
    className="relative overflow-hidden px-6 pt-28 pb-16 md:px-12 lg:px-16 lg:pt-32 lg:pb-20 min-h-screen">
    {/* Background blobs */}
    ...
    <div className="absolute right-0 top-0 -z-10 h-72 w-72 rounded-full bg-blue-500/20 blur-3xl lg:right-[-8rem]" />
    <div className="absolute left-0 bottom-6 -z-10 h-72 w-72 rounded-full bg-sky-300/20 blur-3xl lg:left-[-6rem]" />
    ...
    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
      ...
      <Motion.div
        ...
        <div className="flex flex-wrap gap-4">
          <ScrollLink
            ...
            duration={500}
            offset={-90}
            className="group inline-flex cursor-pointer items-center gap-2 rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-[0_20px_50px_-20px_rgba(37,99,235,0.9)] transition hover:bg-blue-700 md:px-7 md:py-4 md:text-base">
            Start Your Project
          ...
          <ScrollLink
            ...
            duration={500}
            offset={-90}
            className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-blue-200 bg-white px-6 py-3 text-sm font-semibold text-blue-700 transition hover:border-blue-300 hover:bg-blue-50 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 md:px-7 md:py-4 md:text-base">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            <div
              key={label}
              className="glow-border rounded-3xl border border-white/60 bg-white/75 p-5 shadow-lg shadow-blue-100/50 backdrop-blur dark:border-white/10 dark:bg-white/10 dark:shadow-none">
      ...
      <Motion.div
        ...
        <div className="glow-border relative overflow-hidden rounded-[2rem] border border-white/60 bg-white p-4 shadow-[0_40px_120px_-40px_rgba(37,99,235,0.65)] dark:border-white/10 dark:bg-slate-900/80">
          <img
            src={HeroCom}
            alt="Kanel innovations digital services"
            className="w-full rounded-[1.5rem] object-cover"
            style={{ height: 'min(calc(100vh - 10rem), 580px)' }}
          />
          <div className="absolute inset-x-6 bottom-6 rounded-[1.75rem] border border-white/60 bg-slate-950/85 p-5 text-white shadow-xl backdrop-blur sm:inset-x-8 sm:bottom-8 sm:p-6">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.25em] text-blue-200 sm:text-sm">
                  Delivery Stack
                </p>
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-xs text-blue-50/90 sm:mt-5 sm:gap-3 sm:text-sm">
              {[
                'Web & mobile products',
                ...
                <div key={item} className="rounded-2xl bg-white/10 px-3 py-2 sm:px-4 sm:py-3">
                  {item}
                </div>
              ))}
            </div>
        ...
        <div className="absolute -left-6 top-8 hidden rounded-3xl border border-white/60 bg-white/85 px-5 py-4 shadow-xl backdrop-blur dark:border-white/10 dark:bg-slate-900/85 xl:block">
...
/* ── ABOUT ────────────────────────────────────────────────────── */
export const About = () => (
  <AnimatedSection id="about" className="px-6 py-20 md:px-12 md:py-24 lg:px-16">
    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">

      {/* Image block — stacks on top on mobile */}
      <Reveal direction="left">
        <div className="relative">
          <div className="absolute -left-4 -top-4 h-40 w-40 rounded-full bg-blue-200/40 blur-3xl dark:bg-blue-500/20" />
          <div className="glow-border relative overflow-hidden rounded-[2rem] border border-white/50 bg-white p-3 shadow-2xl shadow-blue-100/60 dark:border-white/10 dark:bg-slate-900 sm:p-4">
            <img
              src={TeamImage}
              alt="Kanel innovations team"
              className="w-full rounded-[1.5rem] object-cover"
              style={{ height: 'min(60vw, 480px)', minHeight: '220px' }}
            />
          </div>
        </div>
      </Reveal>
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-5">
            {[
              ...
              <Reveal key={point} delay={i * 80} direction="scale">
                <div className="glow-border rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5">
...
export const Team = () => (
  <AnimatedSection
    id="team"
    className="bg-[linear-gradient(180deg,var(--bg-secondary),var(--bg-primary))] px-6 py-20 md:px-12 md:py-24 lg:px-16">
    <div className="mx-auto max-w-7xl">
      <Reveal direction="up">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-3xl font-black text-slate-950 dark:text-white sm:text-4xl md:text-5xl">
      ...
      <div className="mt-12 grid gap-5 sm:grid-cols-2 md:gap-6 xl:grid-cols-3">
        {serviceCards.map((card, index) => {
          const [title, description, Icon] = card;
          return (
            <Reveal key={title} delay={index * 80} direction="scale">
              <Motion.div
                whileHover={{ y: -4 }}
                className="glow-border group h-full rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm transition hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-100/50 dark:border-white/10 dark:bg-white/5 dark:hover:border-blue-400/30 dark:hover:shadow-none sm:p-7">
                ...
                <h3 className="mt-5 text-xl font-bold text-slate-900 dark:text-white sm:mt-6 sm:text-2xl">
                  {title}
                </h3>
                <p className="mt-3 leading-7 text-slate-600 dark:text-slate-300 sm:mt-4">
                  {description}
                </p>
              </Motion.div>
            </Reveal>
...
export const Projects = () => (
  <AnimatedSection id="projects" className="px-6 py-20 md:px-12 md:py-24 lg:px-16">
    <div className="mx-auto max-w-7xl">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        ...
        <Reveal direction="left">
          <div className="space-y-6">
            ...
            <div className="glow-border rounded-[2rem] border border-blue-200 bg-blue-600 p-6 text-white shadow-2xl shadow-blue-600/20 dark:border-blue-400/20 sm:p-8">
              <div className="flex items-center gap-3">
                <Megaphone className="h-6 w-6 flex-shrink-0" />
                <p className="font-semibold uppercase tracking-[0.2em] text-blue-100 text-sm">
        ...
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-5">
          {showcaseItems.map(([title, detail], index) => (
            <Reveal key={title} delay={index * 100} direction="scale">
              <div className="glow-border h-full rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5 sm:p-7">
                <div className="text-sm font-semibold uppercase tracking-[0.2em] text-blue-700 dark:text-blue-200">
                  0{index + 1}
                </div>
                <h3 className="mt-4 text-xl font-bold text-slate-900 dark:text-white sm:text-2xl">
                  {title}
                </h3>
                <p className="mt-3 leading-7 text-slate-600 dark:text-slate-300 sm:mt-4">
                  {detail}
...
export const Testimonials = () => (
  <AnimatedSection
    id="testimonials"
    className="bg-[linear-gradient(180deg,var(--bg-primary),var(--bg-secondary))] px-6 py-20 md:px-12 md:py-24 lg:px-16">
    <div className="mx-auto max-w-7xl">
      ...
      {/* Testimonials */}
      <div className="mt-12 grid gap-5 md:gap-6 lg:grid-cols-3">
        {testimonialCards.map(([quote, name, company], index) => (
          <Reveal key={`${name}-${company}`} delay={index * 100} direction="up">
            <div className="glow-border h-full rounded-[2rem] bg-slate-950 p-7 text-white shadow-2xl shadow-slate-900/20 dark:bg-[#071a38] sm:p-8">
              <div className="flex gap-1 text-blue-300">
                {Array.from({ length: 5 }).map((_, starIndex) => (
                  <Star key={starIndex} className="h-4 w-4 fill-current" />
                ))}
              </div>
              <p className="mt-5 text-base leading-8 text-slate-100 md:text-lg">{quote}</p>
...
/* ── BLOG ─────────────────────────────────────────────────────── */
export const Blog = () => (
  <AnimatedSection id="blog" className="px-6 py-20 md:px-12 md:py-24 lg:px-16">
    <div className="mx-auto max-w-7xl">
      <Reveal direction="up">
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          ...
          <RouterLink
            to="/blog-news"
            className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white px-6 py-3 font-semibold text-blue-700 transition hover:bg-blue-50 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 whitespace-nowrap">
            Browse All Articles
      ...
      <div className="mt-12 grid gap-5 md:gap-6 md:grid-cols-3">
        {blogPosts.slice(0, 3).map((post, index) => (
          <Reveal key={post.id} delay={index * 100} direction="scale">
            <Motion.article
              whileHover={{ y: -4 }}
              className="glow-border h-full overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition hover:shadow-2xl hover:shadow-blue-100/40 dark:border-white/10 dark:bg-white/5 dark:hover:shadow-none">
              ...
              <div className="p-6 sm:p-7">
                ...
                <h3 className="mt-4 text-xl font-bold text-slate-900 dark:text-white sm:mt-5 sm:text-2xl">
                  {post.title}
                </h3>
                <p className="mt-3 line-clamp-3 leading-7 text-slate-600 dark:text-slate-300 sm:mt-4">
                  {post.excerpt}
                </p>
                <RouterLink
                  to="/blog-news"
                  className="mt-5 inline-flex items-center gap-2 font-semibold text-blue-700 dark:text-blue-200 sm:mt-6">
                  Read Article
                  <ArrowRight className="h-4 w-4" />
                </RouterLink>
              </div>
...
export const Contact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      setFormStatus({
        isSubmitting: false,
        isSubmitted: false,
        error: 'Email service is not configured yet. Add EmailJS keys to your .env file.',
      });
      return;
    }
    ...
    try {
      ...
      setFormStatus({
        isSubmitting: false,
        isSubmitted: false,
        error: 'Message failed to send. Please check your EmailJS template settings and try again.',
      });
    }
  };
  ...
  return (
    <AnimatedSection id="contact" className="px-6 py-20 md:px-12 md:py-24 lg:px-16">
      <div className="mx-auto max-w-7xl">
        <Reveal direction="up">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex rounded-full bg-blue-100 px-4 py-2 text-sm font-semibold text-blue-700 dark:bg-blue-500/15 dark:text-blue-200">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <Reveal direction="left" delay={100}>
            <div className="glow-border rounded-[2rem] border border-slate-200 bg-white p-6 shadow-2xl shadow-blue-100/40 dark:border-white/10 dark:bg-[#071428]/85 dark:shadow-none sm:p-8">
                  ...
                  {[
                    ...
                    <div key={id}>
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-100 dark:border-white/10 dark:bg-white/5 dark:text-white dark:focus:bg-white/10 dark:focus:ring-blue-500/20 sm:py-4"
                      />
                    </div>
                  ))}
                </div>
          ...
          <Reveal direction="right" delay={150}>
            <div className="space-y-5 sm:space-y-6">
              <div className="glow-border rounded-[2rem] bg-blue-600 p-6 text-white shadow-2xl shadow-blue-600/20 sm:p-8">
                ...
                <p className="mt-5 text-sm leading-8 text-blue-50 sm:text-base">
              ...
              {contactCards.map((card) => {
                ...
                return (
                  <div
                    key={title}
                    className="glow-border rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5 sm:p-6">
                    ...
                    <h4 className="mt-4 text-lg font-bold text-slate-900 dark:text-white sm:text-xl">
                      {title}
                    </h4>
                    {lines.map((line) => (
                      <p key={line} className="mt-2 text-sm leading-7 text-slate-600 dark:text-slate-300 sm:text-base">
                        {line}
                      </p>
                    ))}
                  </div>
